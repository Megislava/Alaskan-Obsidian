...
1. GPRs (general purpose registers)
	- `eax` - accumulator register - to accumulate results of arithmetic operations
...
1. Other
	1. `lea`
		...
		- e.g.: `int i = 7 [100]; char j = 5 [200]; int k = i + j [300]`
			- traditionally: 
...
- a lot of ports: [[Attachments/22.PNG]]
- `in register, port`
...
1. **eflags**
	...
	- **overflow flag** - OF - Bit 11
		...
		- [[Attachments/23.PNG]]
	- [[Attachments/24.PNG]] vs [[Attachments/25.PNG]] vs [[Attachments/26.PNG]] vs [[Attachments/27.PNG]] vs [[Attachments/28.PNG]]
	- [[Attachments/29.PNG]] vs [[Attachments/30.PNG]] ...


### Logic Flows
- `eip`
	- holds the address of the current instruction
	- automatically incremented by the processor after each instruction executes
